...
const createLimit = rateLimit({ windowMs: HOUR, max: 30, key: byUser, message: "You're creating rooms too quickly. Try again later." });
const inviteLimit = rateLimit({ windowMs: HOUR, max: 30, key: byUser, message: "You've sent a lot of invitations. Try again later." });
